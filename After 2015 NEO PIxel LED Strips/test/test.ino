...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x00, 0xE2, 0x3B };    // MAC address
IPAddress ip(192,168,1, 130);                               // IP address
...
const byte LED_pins[] = {8};          // Arduino pins used as ouputs for LEDs
...
void DisplayLEDs(Client *client)
{
    ...
    client->print("<h1 style=\"font: normal 20px/150% Verdana, Arial, Sans-serif;\">Robot LED Strip 2015</h1>");
